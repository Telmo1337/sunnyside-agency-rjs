...
const EggAbout = () => {
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 items-center px-4 md:px-0'>
            <div className='space-y-6 md:space-y-12 md:ml-10 lg:ml-28'>
                <h1 className='text-3xl md:text-5xl lg:text-6xl md:w-4/6 font-fraunces font-black text-[#23303e]'>
            ...
            <div className='mt-6 md:mt-0'>
                <img src={egg} alt="egg" className='w-full h-auto max-h-[500px] object-cover' />
            </div>
        </div>
    );
};
